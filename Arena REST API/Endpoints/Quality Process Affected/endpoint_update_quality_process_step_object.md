...
Updates an existing  with a given GUID in a step with a given GUID in a Quality Process with a given GUID.  Current supported Affected Objects are ITEMS, CHANGES, SUPPLIERS, SUPPLIER ITEMS, FILES, QUALITY, and URLs.
