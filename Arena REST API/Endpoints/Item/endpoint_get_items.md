...
| assemblyType  | String  | Possible values include: TOP_LEVEL_ASSEMBLY; ASSEMBLY; NOT_AN_ASSEMBLYTop level assemblies are items that contain assemblies but themselves are not included as items in another item's assembly.<br>   |
