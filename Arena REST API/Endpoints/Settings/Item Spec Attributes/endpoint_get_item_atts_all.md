...
| creatableOnly | true or false | If this is set to true, it returns only creatable attributes, which can be set during creation of an item. |
...
If this is set to false, it returns only non\-creatable sattributes.
