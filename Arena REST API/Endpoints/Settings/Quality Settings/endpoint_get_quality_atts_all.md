...
| creatableOnly  | true or false  | If this is set to true, it returns only creatable attributes, which are settable during creation of a quality processIf this is set to false, it returns only non-creatable attributes.<br> .  |
